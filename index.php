...
` The carpet, though threadbare today, had evidently once presented as a shimmering marvel of the finest Phoenician handiwork. Alas! its present owner had been reckless, negligent even: the beauteous images of men riding horseback, of damsels frolicking in the fields, of mischievous naked cherubs whispering to one another and preparing to dispatch arrows - all of these were now incomplete, their threads having been buffeted by all manner of incidents: contact with smoke, spears, children's scissors… But the state of the rug was really no concern of Zufrieda's. She turned her attention back to Lord Dunstevvy and his swollen, ring-heavy fingers. <br>\
 ...
 \"My Lord,\" she sputtered, blanching, \"that's the tree round which is built my grandmother's house!\" `,
...
function startOrbCanvas(width, height) {
  ...
  function renderMainUI(preview) {
    document.body.innerHTML = `
      <div class="square-container">
        ...
        <div class="wizard-container">
          <img src="assets/img/webp/wizard.webp" alt="Wizard Body" class="wizard-body" />
          <div  class="wizard-hands" style="position:absolute; width: 100%; height: 100%;">
            <canvas id="canvas" width=1200 height=800 style="border:0px solid #d3d3d3; position: absolute; top: 54%; left: 74.25%; z-index: 0;">
            Your browser does not support the HTML5 canvas tag.</canvas>
            <img src="assets/img/webp/wizard_hands_r.webp" alt="Wizard Hands" style="position:absolute; width: 110%; height: 115%;" />
          </div>
          <img src="assets/img/webp/wizard_hands_l.webp" alt="Wizard Hands" class="wizard-finger" style="position:absolute; width: 110%; height: 115%;" />
        </div>
        <div class="text-box">
        ...
        <div class="options-bar">
          <div class="options-buttons">
            <div class="button" id="option1" style="background-image: url('assets/img/webp/toolbar_frame.webp');"></div>
            <div class="button" id="option2" style="background-image: url('assets/img/webp/toolbar_helpbtn.webp');"></div>
            <div class="button" id="option3" style="background-image: url('assets/img/webp/toolbar_quillbtn.webp');"></div>
            <div class="button" id="option4" style="background-image: url('assets/img/webp/toolbar_book.webp');"></div>
            <div class="button" id="option5" style="background-image: url('assets/img/webp/toolbar_menubtn.webp');"></div>
            <div class="button" id="option6" style="background-image: url('assets/img/webp/toolbar_searchbtn.webp');"></div>
          </div>
    ...
    const page = document.body;
      ...
      if(preview) text.innerHTML = `Oh! We are not accepting Commissions just yet! Submit your name to the <span id="mail" style="color: blue; text-decoration: underline; cursor: pointer;">mailing list</span> if you wish for tidings!`
  ...
  function renderScrolls(scroll) {
    ...
    document.body.innerHTML = `
      <div class="square-container">
        ...
        <img src="assets/img/webp/scroll.webp" alt="scroll" style="max-width: 100%"/>
        ...
        <img src="assets/img/webp/scroll_mouse.webp" alt="mouse"  style="position: absolute; top: 8%; left:0px; max-height: 100%; max-width: 100%; z-index: 2"/>
  ...
  function renderSearch(scroll) {
    ...
    document.body.innerHTML = `
      <div class="square-container">
        ...
        <img src="assets/img/webp/search_mg.webp" alt="searching glass" style="max-width: 100%"/>
    ...
    document.body.innerHTML = `
      <div class="square-container">
        ...
        <div style="position:absolute; width: 100%; height: 100%;">
          ...
          <img src="assets/img/webp/search_resultsBox.webp" alt="frame" style="max-width: 100%; z-index: 1; position: absolute;"/>
          ...
          <img src="assets/img/webp/search_resultGlass.webp" alt="searching glass" style="max-width: 100%; z-index: 2; position: absolute; pointer-events: none;"/>
          <img src="assets/img/webp/search_resultFrame.webp" alt="frame" style="max-width: 100%; z-index: 2; position: absolute;pointer-events: none;"/>
      ...
      <div class="square-container">
        <div class="background"></div>
          <div class="crystalbackground">
            ...
            <img src="assets/img/webp/songbook_open.webp" alt="songbook"  style="position: absolute; max-width: 100%; max-height: 100%; pointer-events: none; "/>
            <img src="assets/img/webp/songbook_flip_s.webp" alt="flip" id="flipL" style="position: absolute; top: 56.5%; left: 12.3%; z-index: 6; display: none; max-width: 13%"/>
            <img src="assets/img/webp/songbook_flip_s.webp" alt="flip" id="flipR" style="position: absolute; top: 57%; left: 74.5%; transform: scale(-1, 1); z-index: 6; display: none;  max-width: 13%"/>
            ...
            <div>
            <img src="assets/img/webp/purchase_textmouse.webp" style="position: absolute; top: 0%; left:0px; max-height: 100%; max-width: 100%; z-index: 1; pointer-events: none; "/>
...
const ballads = ["ballad_seven", "ballad_sftsk", "ballad_milady", "ballad_example1", "ballad_example2", "ballad_example3"];
const balladNames = ["Seven", "Seeking For the Sea King", "Milady", "this ballad", "this ballad", "this ballad"];
    ...
    document.body.innerHTML = `
      <div class="square-container">
        ...
        <div class="inspectpage">
          <img src="assets/img/webp/songbook_detail_transparent.webp" alt="songbook"  style="position: absolute; top: -22%; left:-12%; width: 200%; pointer-events: none;"/>
        
          <img src="assets/img/webp/${song}.webp" alt="seven"  style="position: absolute; top: 16%; left:13%; width: 75%; padding-bottom: 50%; z-index: -1"/>
        </div>
        <div>
          <img src="assets/img/webp/purchase_textmouse.webp" style="position: absolute; top: 0%; left:0px; max-height: 100%; max-width: 100%; z-index: 1; pointer-events: none; "/>
            <div style="position: absolute; left: 28%; top: 81%; z-index: 3; width: 59%;" class="text-container">
            <p style="font-size: 0.85rem;">I much like "${balladNames[ballads.indexOf(song)]}" myself! Would you like to purchase a copy?</p>
            </div>
        </div>
        <img src="assets/img/webp/button_back.webp" alt="back" id="buttonBack"  class="buttonBack"  style="cursor: pointer; position: absolute; top: 2%; left: 2%; max-width: 100%; width: 7%; z-index: 3"/>
        </div>
  ...
  function renderMail() {
    ...
    document.body.innerHTML = `
      <div class="square-container">
        ...
        <img src="assets/img/webp/mail_form.webp" alt="form" style="max-width: 100%"/>
        ...
        <span style="font-weight: bold; font-size: 2.1rem; color: #2E2B1D; position: absolute; top: 29%; left:10%; max-height: 100%; max-width: 100%; z-index: 2">Secret Wizard Scrolls <span style="font-size: 1.5rem">shall</span></span>
        <span style="font-weight: bold; font-size: 1.4rem; color: #2E2B1D; position: absolute; top: 38%; left:11%; max-height: 100%; max-width: 100%; z-index: 2">be ready for public perusal! Please</span>
        <span style="font-weight: bold; font-size: 1.4rem; color: #2E2B1D; position: absolute; top: 44%; left:31%; max-height: 100%; max-width: 100%; z-index: 2">provide us with your:</span>
        
        <img src="assets/img/webp/mail_name.webp" alt="name" style="position: absolute; top: 0; left: 0; max-width: 100%"/> 
        <img src="assets/img/webp/mail_email.webp" alt="email" style="position: absolute; top: 0; left: 0; max-width: 100%"/> 
        <img src="assets/img/webp/mail_mouse.webp" id="mouse" alt="mouse" style="transform-origin: 50% 50%; position: absolute; top: 0; left: 0; max-width: 100%"/> 
        <img src="assets/img/webp/mail_hands.webp" id="hands" alt="point" style="position: absolute; top: 0; left: 0; max-width: 100%"/> 
        <img src="assets/img/webp/mail_submit.webp" id="submit" alt="submit" style="position: absolute; top: 0; left: 0; max-width: 100%;"/> 
  ...
  function renderCommissions(scroll) {
    ...
    document.body.innerHTML = `
      <div class="square-container">
        ...
        <img src="assets/img/webp/purchase_book.webp" alt="scroll" style="max-width: 100%"/>
        ...
        <p id="textp1" style="padding: none; margin: none; text-align: justify; overflow-wrap: break-word; overflow: hidden; color: #795841; font-size: 24px; line-height: 24px; font-weight: bold; opacity: 90%; position: absolute; top: 33%; left: 30%; transform: rotateX(-10deg) skewX(2deg); z-index: 0; width: 450px; height: 370px; border:;"></p>
        <p id="textp2" style="padding: none; margin: none; text-align: justify; overflow-wrap: break-word; overflow: hidden; color: #795841; font-size: 24px; line-height: 24px; font-weight: bold; opacity: 90%; position: absolute; top: 17%; left: 81%; transform: rotateX(20deg) skewX(10deg); z-index: 0; width: 450px; height: 550px; border:;"></p>
        <p id="sizer" style='padding: none; margin: none; text-align: justify; overflow-wrap: break-word; font-size: 24px; line-height: 24px; font-weight: bold; position: absolute; top: 33%; left: 30%; transform: rotateX(-10deg) skewX(2deg); z-index: -1; width: 450px; visibility: hidden; white-space: normal;'><p/>
