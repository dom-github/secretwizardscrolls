...
* {
 ...
 /* @media only screen and (max-width: 600px) {
    ...
    .background {
      ...
      width: 100%;
      height: 100%;
      background-image: url('https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/background.png?raw=true');
...
.text-box-background {
  ...
  width: 100%;
  height: 100%;
  background-image: url('https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/text_mouse.png?raw=true');
...
.options-background {
  ...
  width: 100%;
  height: 100%;
  background-image: url('https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/toolbar_bg.png?raw=true');
      ...
      <div class="square-container">
        ...
        <div class="options-bar">
          <div class="options-buttons">
            <div class="button" id="option1" style="background-image: url('https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/toolbar_frame.png?raw=true');"></div>
            <div class="button" id="option2" style="background-image: url('https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/toolbar_helpbtn.png?raw=true');"></div>
            <div class="button" id="option3" style="background-image: url('https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/toolbar_quillbtn.png?raw=true');"></div>
            <div class="button" id="option4" style="background-image: url('https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/toolbar_book.png?raw=true');"></div>
            <div class="button" id="option5" style="background-image: url('https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/toolbar_menubtn.png?raw=true');"></div>
            <div class="button" id="option6" style="background-image: url('https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/toolbar_searchbtn.png?raw=true');"></div>
          </div>
  ...
  function renderBallad(song) {
    ...
    document.body.innerHTML = `
      <div class="square-container">
        ...
        <img src="https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/purchase_textmouse.png?raw=true" style="position: absolute; top: 0%; left:0px; max-height: 100%; max-width: 100%; z-index: 2; pointer-events: none;"/>
        <img src="https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/button_back.png?raw=true" alt="back" id="buttonBack"  class="buttonBack"  style="cursor: pointer; position: absolute; top: 2%; left: 2%; max-width: 100%; width: 7%; z-index: 3"/>
        </div>
        </div>
      </div>
  ...
  function renderMail() {
    ...
    document.body.innerHTML = `
      <div class="square-container">
        ...
        <img src="https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/mail_name.png?raw=true" alt="name" style="position: absolute; top: 0; left: 0; max-width: 100%"/> 
        <img src="https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/mail_email.png?raw=true" alt="email" style="position: absolute; top: 0; left: 0; max-width: 100%"/> 
        <img src="https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/mail_mouse.png?raw=true" id="mouse" alt="mouse" style="transform-origin: 50% 50%; position: absolute; top: 0; left: 0; max-width: 100%"/> 
        <img src="https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/mail_hands.png?raw=true" id="hands" alt="point" style="position: absolute; top: 0; left: 0; max-width: 100%"/> 
    ...
    let jump = false;
      ...
      function anim(){
          setTimeout(function() {
          const rot = jump ? 7 : 0;
          const img = jump ? "mail_hands_twist.png" : "mail_hands.png";
          if(email.value.match(/^\S+@\S+\.\S+$/))hands.src = `https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/${img}?raw=true`;
      ...
      // const submit = document.getElementById(`submit`);
      submitBtn.onclick = () => {
        submit.src = "https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/mail_submit_down.png?raw=true";
        setTimeout(function() {
        submit.src = "https://github.com/dom-github/secretwizardscrolls/blob/main/assets/img/mail_submit.png?raw=true";
        }, 200);
      };
      // submit.addEventListener('mouseenter', () => {
      //   submit.style.color = "#ffffff";
